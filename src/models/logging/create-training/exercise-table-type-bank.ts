...
export class ExerciseTableTypeBank {
    ...
    constructor() {
        this.exerciseTableTypeBank = [
            ...
            new ExerciseTableType('Weight & 1RM',['Detail', 'Weight', '%1RM', 'Reps']), // need to break into many categories here like strong
            new ExerciseTableType('Weight & Reps',['Detail', 'Weight', 'Reps']),
            new ExerciseTableType('Reps Only',['Detail', 'Reps']),
            new ExerciseTableType('Duration',['Detail', 'Time']),
