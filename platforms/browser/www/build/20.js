...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__select_exercise_category__ = __webpack_require__(697);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_training_exercises_exerciseProvider__ = __webpack_require__(450);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SelectExerciseCategoryPage = (function () {
    function SelectExerciseCategoryPage(navCtrl, navParams, banks, viewCtrl, modalCtrl) {
    ...
    SelectExerciseCategoryPage.prototype.createNewExerciseCategory = function () {
        var _this = this;
        var newExerciseCatModal = this.modalCtrl.create('CreateExerciseCategoryPage');
        newExerciseCatModal.onDidDismiss(function (data) {
            if (data) {
